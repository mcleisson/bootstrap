...
function responsivo_scripts(){
    #wp_enqueue_style( 'bootstrap', get_template_directory_uri(), '/vendor/fontawesome-free/css/all.min.css' );
    wp_enqueue_style( 'bootstrap', get_template_directory_uri().'/css/freelancer.min.css' );
